                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                <a class="btn btn-increase" style="margin-left: 7px; margin-right:5px" href="#"></a>
                                <input type="text" name="product-quatity" style="text-align: center;margin-left:5px"
                                    value="1" data-max="120" pattern="[0-9]*">
